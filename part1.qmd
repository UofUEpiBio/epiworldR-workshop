...
[^compartments]: This feature is currently under development. The [repository of epiworld](https://github.com/UofUEpiBio/epiworld){target="_blank"} contains a branch with this feature.
...
analyze changes in counts over time. When running the model, use seed = 1912. 
